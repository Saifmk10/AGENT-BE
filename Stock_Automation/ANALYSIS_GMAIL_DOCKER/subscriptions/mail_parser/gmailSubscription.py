# this module plays the main role where the mail is send to the user with the report genreated by the mailParserModule.py

# What this module does:
# 1.    This module will recive the process data from the mailParserModule.py 
# 2.    The data is then send to the users , this works on a weekly basis in the cron job
